                ...
                >
                    {
                        ...
                        <img
                            ...
                            style={{ minWidth: 200, maxWidth: 200, aspectRatio: "1/1", borderRadius: 8 }}
                        ...
                        <Skeleton
                            ...
                            />
                        :
                        <div style={{minWidth: 200, maxWidth: 200, aspectRatio: "1/1", borderRadius: 8, background: 'linear-gradient(45deg, var(--primary-color), var(--secondary-color))'}}></div>
                    }    
                    <Heading title={collection?.item.name ?? "-"} as={motion.p} size="md" noOfLines={1} variants={textMotion}> {collection?.item.name ?? "-"}</Heading>
                </VStack>
            </Link>

            <VStack align="start" gap={0}>
                <Text style={{fontSize: 12}} color="gray.400">Total: {totalListings}</Text>
